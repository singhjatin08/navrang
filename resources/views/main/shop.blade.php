                ...
                <div class="shop-filter">
                    ...
                    <div class="shop-filter-default justify-content-center">
                        ...
                        <div class="shop-filter-dropdown dropdown">
                            <button class="shop-filter-dropdown__btn" type="button" data-bs-toggle="dropdown"
                                data-bs-auto-close="outside">
                                <span class="text">Category</span>
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                        viewBox="0 0 10 6">
                                        <path d="m0 0 5 6 5-6Z" fill="currentColor"></path>
                                    </svg>
                                </span>
                            </button>
                            <!-- widget Item Start -->
                                ...
                                <div class="single-product js-scroll ShortFadeInUp">
                                    <div class="single-product__thumbnail">
                                        ...
                                        <div class="single-product__thumbnail--meta-2">
                                            <a href="#" data-product-id="{{ $product->product_id }}" class="add-to-cart">
