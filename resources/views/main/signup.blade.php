                    ...
                    <div class="login-register">
                        ...
                        <form action="{{route('signupProcess')}}" method="post" id="signupForm">
                            ...
                            <div class="login-register__form">
                                ...
                                <div class="single-form">
                                    <input class="single-form__input" type="text" name="phone" placeholder="Phone Number *">
                                    <div class="phone_err error"></div>
                                </div>
                                <div class="single-form">
                                    <input class="single-form__input" type="email" name="email" placeholder="Email address *">
