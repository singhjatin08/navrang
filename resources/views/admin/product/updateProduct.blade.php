                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="short_description" name="short_description" class="form-control">{{ $product->product_short_description }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <span class="mx-2">
                                                <input type="radio" @if ($product->feature_product == 'Yes') checked @endif
                                                    name="feature_product" value="Yes"> Yes
                                            </span>
                                            <span class="mx-2">
                                                <input type="radio" @if ($product->feature_product !== 'Yes') checked @endif
                                                    name="feature_product" value=""> No
                                            </span>
